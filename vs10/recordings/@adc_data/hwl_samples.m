function [Y, dt, t0, Dtp] = hwl_samples(D, i0, i1, Ddir, dataSet);
...
%   
%   modified by Hsin-Wei Lu to adapt to Unix system
%   Ddir is the file folder that has the .bin file
%%
...
Dtp = dataType(D);
%% deleted and Ddir is replaced by the argument input
%try
