function Dur=DurPanelSTEP(T, EXP, Prefix, Flag, ITDoptions);
...
StepDelay = ParamQuery([Prefix 'StepDelay'], 'Step Delay:', Durstr, 'ms', ...
    'rreal/positive', 'Delay after which the step is applied.',Nchan);
