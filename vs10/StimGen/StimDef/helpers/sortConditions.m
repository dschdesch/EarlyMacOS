...
if ~isfield(P,'ReducedStorage'), P.ReducedStorage = ''; end; % backwards compatible

[P, NsamPre, NsamPost] = local_add_baselineWaveforms(P); % generate zero buffers for silent baseline intervals
P.Presentation = stimpresentx(P.Fsam, NsamPlay(P.Waveform), Ncond, Nrep, iCond, iRep, X, Y, [NsamPre, NsamPost], P.ReducedStorage);
