function P = xor(S,T);
% tsig/xor - XOR for tsig objects
%    xor(S,T) performs a sample-wise, channel-wise OR between tsig
...
%
%    xor(S,X) and xor(X,S) compare tsig S with logical X and return the 
%    result in a logical tsig. X may be a scalar or a 1 x S.nchan array, 
%    in which case the operation is performed channel-wise.
%
