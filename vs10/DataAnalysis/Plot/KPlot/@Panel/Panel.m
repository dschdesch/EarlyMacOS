...
%   - Added 'Tag' property and removed 'ZColors' and 'ZScale' property
...
newPanel.params.xaxes            = true;
newPanel.params.yaxes            = true;

%by Abel: type of log-format
newPanel.params.logXformat		= 'xlog125';
newPanel.params.logYformat		= 'ylog125';

%By Abel: new color-by-Z-axes option for XYPlotObjects
newPanel.params.ZColor = 'none'; %Options: 'none'	No ZColor
                                   %  'all'     All XYPlotsObjects use the 
								   %            same Z-Axes colormap
								   %  'single'  Each XYPlotsObject uses a
								   %            seperate Z-Axes based on
								   %            its own Y-Values 
newPanel.params.ZColorMap = 'Jet'; %Name of matlab colormap to use 
%Need to draw colorbar
newPanel.params.addZColorbar = false;
%by Abel: add Tag
newPanel.params.Tag = '';
