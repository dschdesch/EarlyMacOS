...
%   - re-added resize function after it was updated
...
defaults.PaperPositionMode  = 'auto';  %Set to auto to auto scale the figure while printing
% defaults.PaperPositionMode  = 'manual';
defaults.PaperUnits         = 'normalized';
% defaults.PaperPosition      = [0.05 0.05 0.90 0.90];  %Sets
% PaperPositionMode to manual
